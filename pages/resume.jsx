...
const resume = () => {
  return (
    <>
      <Head>
        <title>Muhammad Azhar | Resume</title>
        <meta
          name="description"
      ...
      <div className="max-w-[940px] mx-auto p-2 pt-[120px]">
        ...
        <div className="bg-[#e3d5ca] my-4 p-4 w-full flex justify-between items-center">
          <h2 className="text-center text-[#7209b7]">Muhammad Azhar Hasnain</h2>
          <div className="flex">
            <a
              href="https://www.linkedin.com/in/muhammad-azhar-hasnain-21b951114/"
              target="_blank"
              rel="noreferrer"
            >
              <FaLinkedinIn
                size={20}
                style={{ marginRight: "1rem", color: "#7209b7" }}
              />
            </a>
            <a
              href="https://github.com/mycodeDev786"
              target="_blank"
              rel="noreferrer"
            >
              <FaGithub
